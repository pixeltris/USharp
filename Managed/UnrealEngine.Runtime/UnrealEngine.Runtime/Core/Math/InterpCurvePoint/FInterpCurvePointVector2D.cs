...
namespace UnrealEngine.Runtime
{
    ...
    /// </summary>
    [UStruct(Flags = 0x00006008), BlueprintType, UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D", "CoreUObject", UnrealModuleType.Engine)]
    ...
    public struct FInterpCurvePointVector2D : IEquatable<FInterpCurvePointVector2D>
    {
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000205), UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D:InVal")]
        public float InVal;
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D:OutVal")]
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D:ArriveTangent")]
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D:LeaveTangent")]
        ...
        [UProperty(Flags = (PropFlags)0x0018001040000205), UMetaPath("/Script/CoreUObject.InterpCurvePointVector2D:InterpMode")]
        public EInterpCurveMode InterpMode;

        static int FInterpCurvePointVector2D_StructSize;

        public FInterpCurvePointVector2D Copy()
        {
            FInterpCurvePointVector2D result = this;
            return result;
        }
        ...
        {
            IntPtr classAddress = NativeReflection.GetStruct("/Script/CoreUObject.InterpCurvePointVector2D");
            FInterpCurvePointVector2D_StructSize = NativeReflection.GetStructSize(classAddress);
            ...
            NativeReflection.ValidateBlittableStructSize(classAddress, typeof(FInterpCurvePointVector2D));
        }
