...
namespace UnrealEngine.Runtime
{
    ...
    public struct FInterpCurvePointTwoVectors : IEquatable<FInterpCurvePointTwoVectors>
    {
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000205), UMetaPath("/Script/CoreUObject.InterpCurvePointTwoVectors:InVal")]
        public float InVal;
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointTwoVectors:OutVal")]
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointTwoVectors:ArriveTangent")]
        ...
        /// </summary>
        [UProperty(Flags = (PropFlags)0x0018001040000005), UMetaPath("/Script/CoreUObject.InterpCurvePointTwoVectors:LeaveTangent")]
        ...
        [UProperty(Flags = (PropFlags)0x0018001040000205), UMetaPath("/Script/CoreUObject.InterpCurvePointTwoVectors:InterpMode")]
        public EInterpCurveMode InterpMode;

        static int FInterpCurvePointTwoVectors_StructSize;

        public FInterpCurvePointTwoVectors Copy()
        {
            FInterpCurvePointTwoVectors result = this;
            return result;
        }
        ...
        {
            IntPtr classAddress = NativeReflection.GetStruct("/Script/CoreUObject.InterpCurvePointTwoVectors");
            FInterpCurvePointTwoVectors_StructSize = NativeReflection.GetStructSize(classAddress);
            ...
            NativeReflection.ValidateBlittableStructSize(classAddress, typeof(FInterpCurvePointTwoVectors));
        }
