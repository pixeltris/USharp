...
{
    static class Native_FModuleManager
    {
        ...
        public delegate csbool Del_QueryModule(IntPtr instance, ref FName moduleName, ref FModuleStatusNative outModuleStatus);
        ...
        public static Del_QueryModule QueryModule;
