...
struct FActorSpawnParametersInterop
{
	...
	static FActorSpawnParametersInterop FromNative(const FActorSpawnParameters& Instance)
	{
		FActorSpawnParametersInterop Result;
		Result.Name = Instance.Name;
		Result.Template = Instance.Template;
		Result.Owner = Instance.Owner;
		Result.Instigator = Instance.Instigator;
		Result.OverrideLevel = Instance.OverrideLevel;
		return Result;
	}

	static FActorSpawnParameters ToNative(const FActorSpawnParametersInterop& Instance)
	{
